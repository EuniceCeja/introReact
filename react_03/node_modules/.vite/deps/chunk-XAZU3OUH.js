...
var InnerOption = React38.memo(React38.forwardRef(function Option(props, forwardedRef) {
...
var Option2 = React38.forwardRef(function Option3(props, ref) {
  const {
    value
  } = props;
  const {
...
function useTransitionTrigger(requestEnter) {
  const [state, dispatch] = React42.useReducer(transitionStateReducer, {
    elementExited: !requestEnter,
    inProgress: false
  });
  const hasTransition = React42.useRef(false);
  const handleEntering = React42.useCallback(() => {
    dispatch("entering");
  }, []);
  const handleEntered = React42.useCallback(() => {
    dispatch("entered");
  }, []);
  const handleExiting = React42.useCallback(() => {
    dispatch("exiting");
  }, []);
...
function CssTransition(props) {
  ...
  const [isEntering, setIsEntering] = React69.useState(!requestedEnter);
  React69.useEffect(() => {
    if (requestedEnter) {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-XAZU3OUH.js.map
